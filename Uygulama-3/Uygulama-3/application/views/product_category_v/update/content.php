            ...
            <div class="col-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Ürün Kategorisi Güncelleme İşlemi</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo base_url("Product_Category/update/$item->id") ?>">
                  <div class="card-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        ...
                        placeholder="Ürün Kategorisinin Adını Giriniz.">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="<?php echo base_url("Product_Category") ?>" class="btn btn-danger float-right">Vazgeç</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
