...
class Branches extends CI_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules("title", "Şube adı", "required|trim");
		$this->form_validation->set_rules("address", "Şube adresi", "required|trim|is_unique[branches.address]");

		/* Mesajların Oluşturulması  */
		$this->form_validation->set_message(
			array(
				"required" => "<b>{field}</b> alanı doldurulmalıdır.",
				"is_unique" => "Bu adrese kayıtlı bir şube zaten var."
			)
		);
	...
	public function update($id) 
	{
		...
		/* Kuralların Yazılması */
		$this->form_validation->set_rules("title", "Şube adı", "required|trim");
		$this->form_validation->set_rules("address", "Şube adresi", "required|trim");
